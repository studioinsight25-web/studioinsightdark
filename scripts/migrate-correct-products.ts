...
// Correct product data from DEFAULT_PRODUCTS
...
async function migrateCorrectProducts() {
  console.log('🔄 Migrating correct products to database...')

  try {
    // Clear existing products
    console.log('\n1️⃣ Clearing existing products...')
    await prisma.product.deleteMany({})
    console.log('✅ Existing products cleared')

    // Migrate correct products
    console.log('\n2️⃣ Migrating correct products...')
